...
chemin_json = "Thales-Sniffer/Script/fonctions_transfert.json" # Chemin du JSON
...
with open(fichier_binaire, "rb") as f:
    ...
    with open("Thales-Sniffer\Result\ethernet.result_data.csv", mode='w', newline='') as csv_file:
...
with open('Thales-Sniffer\Result\ethernet.result_data.csv', 'r') as csvfile:
