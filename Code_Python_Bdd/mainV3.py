...
cur = conn.cursor()
cur.execute("CREATE TABLE IF NOT EXISTS TRAME(# INTEGER PRIMARY KEY AUTOINCREMENT,numero_trame INTEGER,date TEXT,bench_3 TEXT,bench_5 TEXT, Taille INTEGER,Mac_Src TEXT,Mac_Dst TEXT,type TEXT,Field_2 INTEGER,Field_3 INTEGER,Field_4 INTEGER, Field_5 INTEGER,Field_6 INTEGER,Field_7 INTEGER,MAC_Sender TEXT,Source_IP TEXT,Sender_IP TEXT,Dest_IP TEXT,MAC_Target TEXT,Field_9 INTEGER,Target_IP TEXT,Field_10 INTEGER,Field_11 INTEGER,Field_14 TEXT,Field_16 TEXT,Field_17 TEXT,Field_18 TEXT,Field_20 INTEGER,Field_21 INTEGER,Field_23 TEXT,Field_25 TEXT,Field_26 TEXT,Field_28 TEXT,Field_29 TEXT,Field_30 INTEGER,Field_32 TEXT,Field_33_34_35 TEXT,Packet TEXT,PMID TEXT)")
